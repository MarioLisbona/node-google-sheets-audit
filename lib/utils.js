...
export async function processGoogleSheet(googleSheetId, googleSheetPage) {
  try {
    ...
    console.log("processGoogleSheet func() error", err);
  }
}
...
export async function updateGoogleSheet(
  ...
  try {
    ...
    console.log("updateGoogleSheet func() error", err);
  }
}
